...
rpconfmat
```
We see that the accuracy using this model is only `r rpconfmat$overall['Accuracy']`.
...
rfconfmat
```
We see that the accuracy using this model is `r rfconfmat$overall['Accuracy']`.
...
gbmconfmat
```
We see that the accuracy using this model is `r gbmconfmat$overall['Accuracy']`.
